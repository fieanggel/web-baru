...
export default function RegisterPage() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setError(getUserFriendlyError(err, "Registrasi gagal. Silakan coba lagi."));
    } finally {
          ...
          <div className="relative z-10 max-w-lg">
            <div className="mb-8">
              ...
              <p className="text-xl lg:text-2xl text-on-primary/90 font-headline font-light leading-relaxed">
                Join the network turning waste into measurable progress.
              </p>
            </div>
            <div className="flex gap-8 items-center pt-8 border-t border-on-primary/20">
              <div>
                <p className="text-on-primary font-bold text-2xl tracking-tighter">540+</p>
                <p className="text-on-primary/70 text-xs font-label">Cities Active</p>
              </div>
              <div>
                <p className="text-on-primary font-bold text-2xl tracking-tighter">96%</p>
                <p className="text-on-primary/70 text-xs font-label">Citizen Trust</p>
              </div>
            </div>
          </div>
        </section>

        <section className="flex-1 h-full bg-surface-container-lowest overflow-hidden reveal-right">
          <div className="h-full w-full max-w-md mx-auto flex flex-col justify-start px-8 lg:px-24 pt-12 pb-10 overflow-y-auto no-scrollbar">
            ...
            <div className="w-full reveal-up delay-1">
              <header className="mb-10 text-center md:text-left reveal-up delay-2">
                ...
                <p className="text-on-surface-variant font-body">
                  Start tracking impact, pickups, and community initiatives.
                </p>
              </header>
              ...
              <form className="space-y-6 reveal-up delay-3" method="post" onSubmit={handleSubmit}>
                ...
                <div className="space-y-2">
                  <label className="block text-sm font-bold text-on-surface ml-1" htmlFor="password">
                    Password
                  </label>
                  <div className="relative group">
                    <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-outline group-focus-within:text-primary transition-colors">
